...
struct Game
{
    ...
    map<int, vector<int>>       typeFishes; // key: fish type | value: fishes Ids as vector.
    map<int, bool>              isScannedFish; // key: fish id | value: bool
    map<int, bool>              isScannedByMeFish; // key: fish id | value: bool
    map<int, bool>              isScannedByOpFish; // key: fish id | value: bool
    map<int, bool>              isDeadFish; // key: fish id | value: bool

    // Drone Informations
    vector<Drone>               allDrones;
    vector<int>                 myDrones; // Ids of Drones 
    vector<int>                 opponentsDrones; // Ids of Drones
    ...
    /* this function run just once per Game ! */
    ...
    /* This remaining function run every turn in the Game ! */
